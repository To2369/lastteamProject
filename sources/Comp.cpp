...
//    comp_->GetGameObject()->GetComponent<RenderComp>()->render(gr, comp_->GetGameObject()->GetComponent<TransformComp>()->Gettransform());
//}
...
//            {
//
//                XMFLOAT3 pos{ comp_->GetGameObject()->GetComponent<TransformComp>()->GetPosition() };
...
//            {
//                XMFLOAT3 scale{ comp_->GetGameObject()->GetComponent<TransformComp>()->Getscale() };
...
//            {
//                XMFLOAT3 angle{ comp_->GetGameObject()->GetComponent<TransformComp>()->GetAngle() };
...
//                comp_->GetGameObject()->GetComponent<TransformComp>()->AddPosition(pos);
//                ImGui::TreePop();
//            }
...
//                comp_->GetGameObject()->GetComponent<TransformComp>()->AddScale(scale);
//                ImGui::TreePop();
//            }
//            if (ImGui::TreeNode("Angle"))
//            {
...
//                comp_->GetGameObject()->GetComponent<TransformComp>()->AddAngle(Angle);
//                ImGui::TreePop();
//            }
//        }
//    }
